...
def test_create_user_15_letter_in_first_name_get_sucess_response():
...
def test_create_has_space_in_first_name_get_error_response():
    negative_assert_symbol("A aaa")


def test_create_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")



def test_create_has_number_in_first_name_get_error_response():
